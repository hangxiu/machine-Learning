        ...
        with tf.Session(graph=graph) as sess:
            ...
            for i_epoch in range(begin_epoch, n_epoch):
                ...
                if w_backward-w_forward > 1:
                    ...
                    saver.save(sess, os.path.join(save_dir, 'epoch_%03d' % (i_epoch+1)))
